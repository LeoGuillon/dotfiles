...
tell application "Music"
	...
	set starting_playlist to "DŽbut de session"
	set ending_playlist to "Fin de session"
	set session_duration to "75 minutes"

	delete tracks of playlist session_playlist

  -- fetch a random song from starting_playlist
	set random_starting_track to some track of playlist starting_playlist
	duplicate random_starting_track to playlist session_playlist
  ...
  -- fetch a random song from ending_playlist
	set random_ending_track to some track of playlist ending_playlist
	duplicate random_ending_track to playlist session_playlist
